...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if created:
            self.stdout.write(self.style.SUCCESS("Periodic task (users movie) created successfully!"))
        else:
            self.stdout.write(self.style.WARNING("Periodic task (users movie) already exists!"))
